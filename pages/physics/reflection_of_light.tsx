  ...
  const {user} = useAuth();
    ...
    return (
        ...
        <div className={styles.container}>
            ...
            <h2>Reflection of Light from plane mirror</h2>
            <div className={styles.para}>
            ...
            <h2>Laws of reflection of light</h2>
            <div className={styles.para}>
            ...
            <h2>Formation of image in a plane mirror</h2>
