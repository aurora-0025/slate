    ...
    return (
        ...
        <div className={styles.main}>
            ...
            <div className={styles.coursesContainer}>
                <Link passHref href="/chemistry/structure_of_an_atom">
                <div className={styles.course}>
                    ...
                    <img alt="" src="/pages/chemistry/courses/structureOfAnAtom.svg"  />
                </div>
                </Link>
                <Link passHref href="/chemistry/intro_to_organic_chemistry">
                <div className={styles.course}>
                    ...
                    <img alt="" src="/pages/chemistry/courses/introductionToOrganicChemistry.svg" />
                </div>
                </Link>
                <div className={styles.end}>
					<Link passHref href="/quiz/chemistry"><button>Take A Quiz</button></Link>
                </div>
            </div>
        </div>
